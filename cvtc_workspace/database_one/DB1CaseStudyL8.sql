...
--
-- Temporary view structure for view `avgcostpermile`
--

DROP TABLE IF EXISTS `avgcostpermile`;
/*!50001 DROP VIEW IF EXISTS `avgcostpermile`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `avgcostpermile` AS SELECT 
 1 AS `DroneID`,
 1 AS `AvgCostPerMile`*/;
...
--
-- Temporary view structure for view `droneflights`
--

DROP TABLE IF EXISTS `droneflights`;
/*!50001 DROP VIEW IF EXISTS `droneflights`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `droneflights` AS SELECT 
 1 AS `DroneID`,
 1 AS `Brand`,
 1 AS `Model`,
 1 AS `NumOfFights`*/;
...
--
-- Temporary view structure for view `dropofftime`
--

DROP TABLE IF EXISTS `dropofftime`;
/*!50001 DROP VIEW IF EXISTS `dropofftime`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `dropofftime` AS SELECT 
 1 AS `AvgTimeDifference`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary view structure for view `flightmanifest`
--

DROP TABLE IF EXISTS `flightmanifest`;
/*!50001 DROP VIEW IF EXISTS `flightmanifest`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `flightmanifest` AS SELECT 
 1 AS `FlightID`,
 1 AS `PassID`,
 1 AS `FirstName`,
 1 AS `LastName`*/;
...
--
-- Temporary view structure for view `passengerhistory`
--

DROP TABLE IF EXISTS `passengerhistory`;
/*!50001 DROP VIEW IF EXISTS `passengerhistory`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `passengerhistory` AS SELECT 
 1 AS `FirstName`,
 1 AS `Lastname`,
 1 AS `FlightID`,
 1 AS `PickUpTime`,
...
--
-- Temporary view structure for view `pilotflights`
--

DROP TABLE IF EXISTS `pilotflights`;
/*!50001 DROP VIEW IF EXISTS `pilotflights`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `pilotflights` AS SELECT 
 1 AS `LastName`,
 1 AS `FirstName`,
 1 AS `NumOfFlights`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Final view structure for view `avgcostpermile`
--
...
/*!50001 VIEW `avgcostpermile` AS select `flightreservation`.`DroneID` AS `DroneID`,avg(`flightreservation`.`CostPerMile`) AS `AvgCostPerMile` from (`flightreservation` join `flightstatus` on((`flightreservation`.`StatusID` = `flightstatus`.`StatusID`))) where (`flightreservation`.`StatusID` = 5) group by `flightreservation`.`DroneID` order by `AvgCostPerMile` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `droneflights`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `droneflights` AS select `flightreservation`.`DroneID` AS `DroneID`,`model`.`Brand` AS `Brand`,`model`.`Model` AS `Model`,count(`flightstatus`.`Desc`) AS `NumOfFights` from (((`flightreservation` join `flightstatus` on((`flightreservation`.`StatusID` = `flightstatus`.`StatusID`))) join `drone` on((`flightreservation`.`DroneID` = `drone`.`DroneID`))) join `model` on((`drone`.`ModelID` = `model`.`ModelID`))) where (`flightstatus`.`Desc` in ('In Progress','Complete')) group by `flightreservation`.`DroneID` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `dropofftime`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `dropofftime` AS select avg((`flightreservation`.`EstDropOffTime` - `flightreservation`.`ActDropOffTime`)) AS `AvgTimeDifference` from `flightreservation` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `flightmanifest`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `flightmanifest` AS select `manifestpassenger`.`FlightID` AS `FlightID`,`passenger`.`PassID` AS `PassID`,`passenger`.`FirstName` AS `FirstName`,`passenger`.`LastName` AS `LastName` from (`manifestpassenger` join `passenger` on((`manifestpassenger`.`PassID` = `passenger`.`PassID`))) where (`manifestpassenger`.`FlightID` = 39) order by `passenger`.`LastName` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `passengerhistory`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `passengerhistory` AS select `passenger`.`FirstName` AS `FirstName`,`passenger`.`LastName` AS `Lastname`,`manifestpassenger`.`FlightID` AS `FlightID`,`flightreservation`.`PickUpTime` AS `PickUpTime`,`manifestpassenger`.`SeatPrice` AS `SeatPrice` from ((`passenger` join `manifestpassenger` on((`passenger`.`PassID` = `manifestpassenger`.`PassID`))) join `flightreservation` on((`manifestpassenger`.`FlightID` = `flightreservation`.`FlightID`))) where ((`passenger`.`FirstName` = 'Cody') and (`passenger`.`LastName` = 'Black')) order by `flightreservation`.`PickUpTime` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `pilotflights`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `pilotflights` AS select `remotepilot`.`LastName` AS `LastName`,`remotepilot`.`FirstName` AS `FirstName`,count(`flightreservation`.`RemotePilotID`) AS `NumOfFlights` from (`flightreservation` join `remotepilot` on((`flightreservation`.`RemotePilotID` = `remotepilot`.`PilotID`))) group by `remotepilot`.`LastName` order by `remotepilot`.`LastName` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2019-05-10 17:35:37
